...
It's an experiment in combining RC hardware, embedded programming, wireless controllers, vehicle telemetry, safety systems, and a custom user interface into a single off-road platform.
